...
export const Impact = () => {
    return (
        <section className="flex flex-center flex-col text-center bg-neutral-secondary section">
            <h2 className=" text-secondary-cran-700 h2">Nuestro Impacto</h2>
            <div className='max-w-4xl mx-auto text-center grid spacing-large text-inverse-neutral-secondary'>
                ...
                <div className="final-impact text-start grid spacing-medium">
                    <p className="font-bold text-lg leading-lh-lg md:text-xl md:leading-lh-xl xl:text-2xl xl:leading-lh-2xl text-secondary-cran-700">La Evidencia de Nuestro Éxito:</p>
                    ...
                    <ul className="font-medium text-sm leading-lh-sm md:text-base md:leading-lh-base xl:text-xl xl:leading-lh-xl list-disc list-inside space-y-2">
                        <li className=''><strong className='text-brand-primary-strong'>Impacto Laboral:</strong> Un alto porcentaje de nuestros egresados consigue empleo en roles tecnológicos de alto valor en tiempo récord. Muchos de ellos acceden a nuevas carreras con salarios significativamente superiores a los anteriores.</li>
                        <li className=''><strong className='text-brand-primary-strong'>Innovación Constante:</strong> Nuestros alumnos no solo se adaptan, sino que crean. Lideran equipos en startups disruptivas y corporaciones globales, llevando el pensamiento crítico y la ejecución de proyectos ágiles a la vanguardia de sus organizaciones.</li>
                        <li className=''><strong className='text-brand-primary-strong'>Comunidad Global:</strong> Hemos construido una red de mentores, alumni y partners de la industria que va más allá de la pantalla, ofreciendo oportunidades de networking y crecimiento profesional de por vida.</li>
                    </ul>
                    <br />
                ...
                <br />
                <div className="grid spacing-medium">
                    <p className="font-bold text-center text-xl leading-lh-xl md:text-2xl md:leading-lh-2xl xl:text-3xl xl:leading-lh-3xl text-secondary-cran-700 font-['Space_Grotesk']">¿Estás Listo para Ser el Próximo Caso de Éxito?</p>
                    <p className="text-sm leading-lh-sm md:text-base md:leading-lh-base xl:text-xl xl:leading-lh-xl">Únete a nuestra vibrante comunidad de profesionales orientados al futuro. No te quedes atrás; transforma tu potencial en una carrera imparable.
                    </p>
                    <p className='font-bold text-sm leading-lh-sm md:text-base md:leading-lh-base xl:text-xl xl:leading-lh-xl'>¡Síguenos en nuestras redes! Mantente al día con los últimos cursos, webinars exclusivos, historias de éxito y las noticias más relevantes del sector tecnológico. Tu futuro comienza aquí.</p>
                </div>
            </div>
